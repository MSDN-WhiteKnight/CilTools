...
namespace CilView.Tests.SourceCode
{
    ...
    public class DecompilerTests
    {
        ...
        public void Test_DecompileMethodSignature_Csharp()
        {
            ...
            Assert.AreEqual(SourceTokenKind.FunctionName, tokens[4].Kind);
            ...
            Assert.AreEqual(SourceTokenKind.Keyword, tokens[6].Kind);
            ...
            Assert.AreEqual(SourceTokenKind.OtherName, tokens[8].Kind);
            ...
            Assert.AreEqual(SourceTokenKind.Keyword, tokens[10].Kind);
            ...
            Assert.AreEqual(SourceTokenKind.OtherName, tokens[12].Kind);
            ...
            Assert.AreEqual(SourceTokenKind.Punctuation, tokens[13].Kind);
